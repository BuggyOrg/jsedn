...
(function() {
  ...
  lex = function(string) {
    var c, col, escaping, i, in_comment, in_string, len, line, lines, list, newToken, token;
    list = [];
    lines = [];
    line = 1;
    token = '';
    ...
    newToken = function(name, line, col) {
      ...
      if (this.lastToken) {
        temp.lineStart = this.lastToken.lineEnd;
        temp.colStart = this.lastToken.colEnd;
      }
      this.lastToken = temp;
    ...
    read_ahead = function(token, tokenIndex, expectSet) {
      ...
      if ((!(token.token instanceof StringObj)) && (paren = parenTypes[token.token])) {
        ...
        if (handledToken instanceof Tag) {
          ...
          if (typeof handledToken !== "string" && typeof handledToken !== "number") {
