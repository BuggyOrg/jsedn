...
(function() {
  ...
  Pair = (function() {
    ...
    Pair.prototype.setPos = function(startLine, startCol, endLine, endCol) {
      this.posLineStart = startLine;
      this.posColStart = startCol;
      this.posLineEnd = endLine || startLine;
      return this.posColEnd = endCol || startCol;
    };
  ...
  Map = (function() {
    Map.prototype.setPos = function(startLine, startCol, endLine, endCol) {
      this.posLineStart = startLine;
      this.posColStart = startCol;
      this.posLineEnd = endLine || startLine;
      return this.posColEnd = endCol || startCol;
    ...
    function Map(val1) {
      ...
      if (this.val.length && this.val.length % 2 !== 0) {
        throw "Map accepts an array with an even number of items. You provided " + this.val.length + " items at line " + this.val[0].posLineStart + ":" + this.val[0].posColStart + "-" + this.val[this.val.length - 1].posLineEnd + ":" + this.val[this.val.length - 1].posColEnd;
      }
      this.keys = [];
      this.vals = [];
      ref = this.val;
